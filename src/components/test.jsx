...
const Test = () => {
  ...
  const containerStyles = {
    background: "linear-gradient(to bottom, #0074B8, #3b82f6)",
  };

  return (
    <div className="bg-white dark:bg-gray-900 min-h-screen" style={containerStyles}>
      <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
        ...
        >
          <img
            src={profile}
            alt="Profile"
            className="w-full h-auto lg:w-[80%] lg:h-[80vh] object-cover"
          />
        </motion.div>
      </div>
      <AnimatedLine />
